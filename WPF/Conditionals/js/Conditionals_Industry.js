...
if(unitOfMeasurement != "k" || unitOfMeasurement != "m"){
...
else if(unitOfMeasurement == "k")                                                                                       //User inputted kilometers as unit of measurement
{
    //Output
    //You will be traveling X kilometers, or X miles.
    console.log("You will be traveling " +distance+ " kilometers, or " +(distance/0.6214).toFixed(2)+ " miles.");       //Convert kilometers to miles: 1 mile = 1.609344 kilometers

}else if(unitOfMeasurement == "m")                                                                                      //User inputted miles as unit of measurement
{
    //Output
    //You will be traveling X miles, or X kilometers.
    console.log("You will be traveling " +distance+ " miles, or " +(distance*1.609344).toFixed(2)+ " kilometers.");     //Convert miles to kilometers: 1 kilometer = 1 mile/0.62137
}