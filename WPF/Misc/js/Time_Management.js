...
//var totalWorkHours = parseFloat(workHours * 5 * 52 ); //Only 5 work days
//var totalTravelHours = parseFloat(workTravel * 5 * 52); //Only 5 work days
//var totalSleepHours = parseFloat(sleepTime * 7 * 52);  //7 days in a week
//var totalInternetTime = parseFloat(internetTime * 7* 52); //7 days in a week
//var totalPhoneTime = parseFloat(phoneTime * 7 * 52);   //7 days in a week
//
////Convert hours to weeks
////Every 168 hours equals 1 week
//
//if(totalWorkHours >= 168)
//{
//    week++;
//}
//else
